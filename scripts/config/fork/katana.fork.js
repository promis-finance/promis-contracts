/**
 * ============================================================================
 *  Promis deploy config — KATANA MAINNET-FORK REHEARSAL
 * ============================================================================
 *  The REAL katana.js config, unchanged, except:
 *    - roles → deterministic local hardhat accounts (the mainnet file has
 *      nulls, which correctly throw when useMocks=false)
 *    - rehearsal.whales → funded Katana holders to impersonate for SMOKE=1
 *
 ...
 *
 *  Fork a Katana node, then point the scripts at it:
 *    npx hardhat node --fork https://rpc.katana.network --fork-block-number <N>
 ...
 * ============================================================================
 */
const base = require("../mainnet/katana.js");
...
module.exports = {
  ...
  rehearsal: {
    whales: {
      USDC: "0xD50F2DffFd62f94Ee4AEd9ca05C61d0753268aBc",
      USDT: "0xD50F2DffFd62f94Ee4AEd9ca05C61d0753268aBc",
    },
  },
};